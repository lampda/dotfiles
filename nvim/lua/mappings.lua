...
vim.api.nvim_set_keymap("n", "<leader>l", "g<Tab>", { noremap = true })
-- move current tab to previous position
-- move current tab to next position
vim.api.nvim_set_keymap("n", "<leader>mtp", ":-tabmove<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>mtn", ":+tabmove<CR>", { noremap = true })
